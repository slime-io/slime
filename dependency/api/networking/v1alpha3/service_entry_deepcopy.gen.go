...
// DeepCopyInto supports using ServiceEntry_InboundEndPoint within kubernetes types, where deepcopy-gen is used.
func (in *ServiceEntry_InboundEndPoint) DeepCopyInto(out *ServiceEntry_InboundEndPoint) {
	p := proto.Clone(in).(*ServiceEntry_InboundEndPoint)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceEntry_InboundEndPoint. Required by controller-gen.
func (in *ServiceEntry_InboundEndPoint) DeepCopy() *ServiceEntry_InboundEndPoint {
	if in == nil {
		return nil
	}
	out := new(ServiceEntry_InboundEndPoint)
	in.DeepCopyInto(out)
	return out
}
