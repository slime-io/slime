...
// DeepCopyInto supports using ThriftRoute within kubernetes types, where deepcopy-gen is used.
func (in *ThriftRoute) DeepCopyInto(out *ThriftRoute) {
	p := proto.Clone(in).(*ThriftRoute)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ThriftRoute. Required by controller-gen.
func (in *ThriftRoute) DeepCopy() *ThriftRoute {
	if in == nil {
		return nil
	}
	out := new(ThriftRoute)
...
// DeepCopyInto supports using ThriftMatchRequest within kubernetes types, where deepcopy-gen is used.
func (in *ThriftMatchRequest) DeepCopyInto(out *ThriftMatchRequest) {
	p := proto.Clone(in).(*ThriftMatchRequest)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ThriftMatchRequest. Required by controller-gen.
func (in *ThriftMatchRequest) DeepCopy() *ThriftMatchRequest {
	if in == nil {
		return nil
	}
	out := new(ThriftMatchRequest)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto supports using RpcHeaderMatcher within kubernetes types, where deepcopy-gen is used.
func (in *RpcHeaderMatcher) DeepCopyInto(out *RpcHeaderMatcher) {
	p := proto.Clone(in).(*RpcHeaderMatcher)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RpcHeaderMatcher. Required by controller-gen.
func (in *RpcHeaderMatcher) DeepCopy() *RpcHeaderMatcher {
	if in == nil {
		return nil
	}
	out := new(RpcHeaderMatcher)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto supports using DubboMethod within kubernetes types, where deepcopy-gen is used.
func (in *DubboMethod) DeepCopyInto(out *DubboMethod) {
	p := proto.Clone(in).(*DubboMethod)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DubboMethod. Required by controller-gen.
func (in *DubboMethod) DeepCopy() *DubboMethod {
	if in == nil {
		return nil
	}
	out := new(DubboMethod)
...
// DeepCopyInto supports using DubboMethod_ParameterMatchSpecifier within kubernetes types, where deepcopy-gen is used.
func (in *DubboMethod_ParameterMatchSpecifier) DeepCopyInto(out *DubboMethod_ParameterMatchSpecifier) {
	p := proto.Clone(in).(*DubboMethod_ParameterMatchSpecifier)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DubboMethod_ParameterMatchSpecifier. Required by controller-gen.
func (in *DubboMethod_ParameterMatchSpecifier) DeepCopy() *DubboMethod_ParameterMatchSpecifier {
	if in == nil {
		return nil
	}
	out := new(DubboMethod_ParameterMatchSpecifier)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto supports using HttpReturn within kubernetes types, where deepcopy-gen is used.
func (in *HttpReturn) DeepCopyInto(out *HttpReturn) {
	p := proto.Clone(in).(*HttpReturn)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HttpReturn. Required by controller-gen.
...
// DeepCopyInto supports using VirtualCluster within kubernetes types, where deepcopy-gen is used.
func (in *VirtualCluster) DeepCopyInto(out *VirtualCluster) {
	p := proto.Clone(in).(*VirtualCluster)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualCluster. Required by controller-gen.
