...
// MarshalJSON is a custom marshaler for ServiceEntry_InboundEndPoint
func (this *ServiceEntry_InboundEndPoint) MarshalJSON() ([]byte, error) {
	str, err := ServiceEntryMarshaler.MarshalToString(this)
	return []byte(str), err
}

// UnmarshalJSON is a custom unmarshaler for ServiceEntry_InboundEndPoint
func (this *ServiceEntry_InboundEndPoint) UnmarshalJSON(b []byte) error {
	return ServiceEntryUnmarshaler.Unmarshal(bytes.NewReader(b), this)
}
