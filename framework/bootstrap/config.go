...
// SelfResourceRev returns the value of SelfResourceRev. If the value of SelfResourceRev is not empty,
// it will be patched to resources which generated by slime itself, just like serviceFence. But there are
// two exceptions:
//   - smartlimiter/envoyplugin/pluginmanager is excluded because these envoyfilter are generated
//     by users or higher-level services.
