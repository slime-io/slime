...
func (x *SmartLimitDescriptor_HeaderMatcher) Reset() {
	*x = SmartLimitDescriptor_HeaderMatcher{}
	if protoimpl.UnsafeEnabled {
		mi := &file_smart_limiter_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
type SmartLimitDescriptor_Action struct {
	...
	HeadersToAdd map[string]string `protobuf:"bytes,4,rep,name=headers_to_add,json=headersToAdd,proto3" json:"headers_to_add,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // 增添的请求头
}
...
func (x *SmartLimitDescriptor_Action) GetHeadersToAdd() map[string]string {
	if x != nil {
...
var file_smart_limiter_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xc3, 0x08, 0x0a, 0x14,
	...
	0x4d, 0x61, 0x74, 0x63, 0x68, 0x1a, 0xc9, 0x02, 0x0a, 0x06, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x12, 0x78, 0x0a, 0x0e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72,
	0x73, 0x5f, 0x74, 0x6f, 0x5f, 0x61, 0x64, 0x64, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x52,
	...
	0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x6f, 0x72, 0x2e, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	...
	,
	...
	0x73, 0x22, 0x64, 0x0a, 0x06, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x64,
	...
	0x75, 0x74, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x18, 0x04, 0x20, 0x03, 0x28,
	0x09, 0x52, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x42, 0x33, 0x5a, 0x31, 0x73, 0x6c, 0x69, 0x6d, 0x65,
	0x2e, 0x69, 0x6f, 0x2f, 0x73, 0x6c, 0x69, 0x6d, 0x65, 0x2f, 0x73, 0x6c, 0x69, 0x6d, 0x65, 0x2d,
	0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x73, 0x2f, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x65, 0x72, 0x2f,
	0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_smart_limiter_proto_goTypes = []interface{}{
	...
	nil,                           // 6: slime.microservice.limiter.v1alpha2.SmartLimiterSpec.SetsEntry
	nil,                           // 7: slime.microservice.limiter.v1alpha2.SmartLimiterSpec.WorkloadSelectorEntry
	nil,                           // 8: slime.microservice.limiter.v1alpha2.SmartLimiterStatus.RatelimitStatusEntry
	nil,                           // 9: slime.microservice.limiter.v1alpha2.SmartLimiterStatus.MetricStatusEntry
	(*SmartLimitDescriptor_HeaderMatcher)(nil), // 10: slime.microservice.limiter.v1alpha2.SmartLimitDescriptor.HeaderMatcher
	(*SmartLimitDescriptor_Action)(nil),        // 11: slime.microservice.limiter.v1alpha2.SmartLimitDescriptor.Action
	nil,                                        // 12: slime.microservice.limiter.v1alpha2.SmartLimitDescriptor.Action.HeadersToAddEntry
}
var file_smart_limiter_proto_depIdxs = []int32{
	6,  // 0: slime.microservice.limiter.v1alpha2.SmartLimiterSpec.sets:type_name -> slime.microservice.limiter.v1alpha2.SmartLimiterSpec.SetsEntry
	7,  // 1: slime.microservice.limiter.v1alpha2.SmartLimiterSpec.workloadSelector:type_name -> slime.microservice.limiter.v1alpha2.SmartLimiterSpec.WorkloadSelectorEntry
	5,  // 2: slime.microservice.limiter.v1alpha2.SmartLimiterSpec.target:type_name -> slime.microservice.limiter.v1alpha2.Target
	8,  // 3: slime.microservice.limiter.v1alpha2.SmartLimiterStatus.ratelimitStatus:type_name -> slime.microservice.limiter.v1alpha2.SmartLimiterStatus.RatelimitStatusEntry
	9,  // 4: slime.microservice.limiter.v1alpha2.SmartLimiterStatus.metricStatus:type_name -> slime.microservice.limiter.v1alpha2.SmartLimiterStatus.MetricStatusEntry
	11, // 5: slime.microservice.limiter.v1alpha2.SmartLimitDescriptor.action:type_name -> slime.microservice.limiter.v1alpha2.SmartLimitDescriptor.Action
	10, // 6: slime.microservice.limiter.v1alpha2.SmartLimitDescriptor.match:type_name -> slime.microservice.limiter.v1alpha2.SmartLimitDescriptor.HeaderMatcher
	...
	12, // 12: slime.microservice.limiter.v1alpha2.SmartLimitDescriptor.Action.headers_to_add:type_name -> slime.microservice.limiter.v1alpha2.SmartLimitDescriptor.Action.HeadersToAddEntry
...
func file_smart_limiter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_smart_limiter_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
