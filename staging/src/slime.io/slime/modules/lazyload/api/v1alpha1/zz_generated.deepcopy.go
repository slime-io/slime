...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Dispatch.
...
func (in *Fence) DeepCopyInto(out *Fence) {
	*out = *in
	...
	if in.Dispatches != nil {
		in, out := &in.Dispatches, &out.Dispatches
		*out = make([]*Dispatch, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(Dispatch)
