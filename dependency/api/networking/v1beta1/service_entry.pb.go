...
type ServiceEntry struct {
	...
	//调用方服务实例列表
	InboundEndPoints     []*ServiceEntry_InboundEndPoint `protobuf:"bytes,50,rep,name=inboundEndPoints,proto3" json:"inboundEndPoints,omitempty"`
	DubboServiceMode     string                          `protobuf:"bytes,51,opt,name=dubboServiceMode,proto3" json:"dubboServiceMode,omitempty"`
...
func (m *ServiceEntry) GetInboundEndPoints() []*ServiceEntry_InboundEndPoint {
	if m != nil {
		return m.InboundEndPoints
	}
	return nil
}

func (m *ServiceEntry) GetDubboServiceMode() string {
	if m != nil {
		return m.DubboServiceMode
	}
	return ""
}

// 调用方服务实例信息
// 用于为被调用方服务指定其服务调用者的信息
type ServiceEntry_InboundEndPoint struct {
	// 消费者地址
	// 对于dubbo服务，该地址从调用方服务的url中获取
	Address string `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
	//调用方服务端口信息
	//每个端口会有一个名称与之关联，一般为服务名或端口名
...
func (m *ServiceEntry_InboundEndPoint) Reset()         { *m = ServiceEntry_InboundEndPoint{} }
func (m *ServiceEntry_InboundEndPoint) String() string { return proto.CompactTextString(m) }
func (*ServiceEntry_InboundEndPoint) ProtoMessage()    {}
func (*ServiceEntry_InboundEndPoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_be685d9fa1e5ca12, []int{0, 0}
}
func (m *ServiceEntry_InboundEndPoint) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ServiceEntry_InboundEndPoint) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ServiceEntry_InboundEndPoint.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ServiceEntry_InboundEndPoint) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ServiceEntry_InboundEndPoint.Merge(m, src)
}
func (m *ServiceEntry_InboundEndPoint) XXX_Size() int {
	return m.Size()
}
func (m *ServiceEntry_InboundEndPoint) XXX_DiscardUnknown() {
	xxx_messageInfo_ServiceEntry_InboundEndPoint.DiscardUnknown(m)
}

var xxx_messageInfo_ServiceEntry_InboundEndPoint proto.InternalMessageInfo

func (m *ServiceEntry_InboundEndPoint) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (m *ServiceEntry_InboundEndPoint) GetPorts() map[string]uint32 {
	if m != nil {
		return m.Ports
	}
	return nil
...
func (m *ServiceEntry_InboundEndPoint) GetLabels() map[string]string {
	if m != nil {
		return m.Labels
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ServiceEntry_InboundEndPoint)(nil), "istio.networking.v1beta1.ServiceEntry.InboundEndPoint")
	proto.RegisterMapType((map[string]string)(nil), "istio.networking.v1beta1.ServiceEntry.InboundEndPoint.LabelsEntry")
	proto.RegisterMapType((map[string]uint32)(nil), "istio.networking.v1beta1.ServiceEntry.InboundEndPoint.PortsEntry")
}
...
var fileDescriptor_be685d9fa1e5ca12 = []byte{
	...
	,
}
...
func (m *ServiceEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DubboServiceMode) > 0 {
		i -= len(m.DubboServiceMode)
		copy(dAtA[i:], m.DubboServiceMode)
		i = encodeVarintServiceEntry(dAtA, i, uint64(len(m.DubboServiceMode)))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0x9a
	}
	if len(m.InboundEndPoints) > 0 {
		for iNdEx := len(m.InboundEndPoints) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.InboundEndPoints[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ServiceEntry_InboundEndPoint) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ServiceEntry_InboundEndPoint) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ServiceEntry_InboundEndPoint) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ServiceEntry) Size() (n int) {
	...
	if len(m.InboundEndPoints) > 0 {
		for _, e := range m.InboundEndPoints {
			l = e.Size()
			n += 2 + l + sovServiceEntry(uint64(l))
		}
	}
	l = len(m.DubboServiceMode)
	if l > 0 {
		n += 2 + l + sovServiceEntry(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func (m *ServiceEntry_InboundEndPoint) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ServiceEntry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 50:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InboundEndPoints", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.InboundEndPoints = append(m.InboundEndPoints, &ServiceEntry_InboundEndPoint{})
			if err := m.InboundEndPoints[len(m.InboundEndPoints)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 51:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DubboServiceMode", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DubboServiceMode = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *ServiceEntry_InboundEndPoint) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: InboundEndPoint: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: InboundEndPoint: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
